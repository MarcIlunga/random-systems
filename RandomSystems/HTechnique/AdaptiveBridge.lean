...
theorem transcriptLaw_ratio_of_fixedQuery_ratio
  ...
  calc (1 - eps) *
    ...
    _ ≤ RandomSystems.CR18.PFunPDE.transcriptSystemFactor R.prob R.rv xv yv *
        ...
        gcongr
        -- the environment factor is an event mass of `E.prob`, whose `ProbDist`
        -- packaging already carries `NonNeg`; no hypothesis is added
        exact E.prob.property.nonNeg.mass_nonneg _
