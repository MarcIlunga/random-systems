...
theorem filteredDelta_le_advPRF
  ...
  have hRtotNonempty : RandomSystems.CR18.CondEquiv.TotalOnNonempty
    ...
    exact normalizedSoPProbPDS_totalOnNonempty (G := G)
  have hItotNonempty : RandomSystems.CR18.CondEquiv.TotalOnNonempty
      (ProbPDS.urf (X := G) (Y := G)).val := by
    change RandomSystems.CR18.CondEquiv.TotalOnNonempty
      (RandomSystems.CR18.PFunPDS.URF : RandomSystems.CR18.PFunPDS G G)
    exact RandomSystems.CR18.PFunPDS.URF_totalOnNonempty
