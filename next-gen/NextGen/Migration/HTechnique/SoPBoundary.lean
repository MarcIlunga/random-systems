...
* move application-independent H-technique lemmas to `NextGen`;
* rehome the fixed-transcript/visible-law SoP layer over `NextGen`'s
...
theorem sopFixedQueryAdvantage_le
  ...
  exact Finset.sup_le (fun xs _ => sop_statDist_rfDist_le h_bound xs)
